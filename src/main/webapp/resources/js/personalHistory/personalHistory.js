...
var btnEve = function(){	
	...
	$(".personalHistorySaveBtn").unbind().click(function(e){
		...
		if(check) { // 폼의 내용이 유효하면 등록처리
			...
			console.log("############################################## 개인 이력 카드 작성 내용personalHistoryData  : " + personalHistoryData);
			...
			console.log("############################################## - 전송하기위해 고정 데이터와 유동 데이터 합친 결과 값 : "+submitDataObj);
...
//	                alert("상세 주소를 입력해 주세요.")
	...
	$("#userMaritalStatusSelect").on("change",function(){
		var value = $(this).val();
		if(value==""){
